...
/* SOURCE: ./assets/javascripts/app/assessment/assessment_questionnaire/toolbar/toolbar_directive.js */
(function(assessment){
...
(function(assessment){
  ...
  assessment.factory('AssessmentSvc', ['HTAPI', function(api){
    ...
    var attrMap = {
      ...
      1323: {assessmentType: 'Implemented', answerType: 'scope'},
      1317: {assessmentType: 'Measured', answerType: 'response'},
      1324: {assessmentType: 'Measured', answerType: 'scope'},
      1318: {assessmentType: 'Managed', answerType: 'response'}, 
      1325: {assessmentType: 'Managed', answerType: 'scope'}
    };
